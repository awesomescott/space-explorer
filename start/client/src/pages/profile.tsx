...
const Profile: React.FC<ProfileProps> = () => {
  const {
     ...
     * The default policy is cache-first, which means Apollo Client checks the cache
     * to see if the result is present before making a network request.
     * If the result is present, no network request occurs. 
     * 
